...
const Carreer = () => {
  return (
    <div>
      ...
      <p className='text-center text-lg my-[20px] '>Currently, we are looking for Sales executive, video editor, and graphic designer. <br /> <span className='font-bold'>Apply now at : </span> 0333-8400116,    0316-6700948</p>
