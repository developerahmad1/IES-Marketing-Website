...
import img4 from "../../assets/AdamsHousing4.jpg";
import img5 from "../../assets/AdamsHousing5.jpg";
import img6 from "../../assets/AdamsHousing6.jpg";
import img7 from "../../assets/AdamsHousing7.jpg";
import img8 from "../../assets/AdamsHousing8.jpg";
import img9 from "../../assets/AdamsHousing9.jpg";
              ...
              <div className="container px-4 mx-auto">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <p className="max-w-3xl mx-auto mb-10 text-lg text-justify text-gray-300">
                    Adams Housing Multan stands as a beacon of modern living that offers contemporary amenities and high-quality infrastructure and provides residents with convenient access to the city's landmarks and commercial hubs. This society is located at a prime location on Matti Tal Road near New Katchery                  </p>
                  <a
      ...
      <div className="bg-white text-black text-justify min-h-screen py-12 px-4 md:px-20">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-lg leading-relaxed">
              Moreover, their initial projects were focused on smaller residential projects, but they expanded their portfolio to include larger societies and commercial complexes in different cities in Pakistan. <span className='font-bold'> Mr. Riyaz Beryaris </span> is the owner of Adams Housing and the CEO of Adams Developer Group. He is one of the prominent figures in the real estate industry. Mr. Beryar is a former marketing and development manager of Citi Housing Pvt. Ltd. He focuses on the integration of cutting-edge infrastructure and sustainable practices within society.
            </p>
          </section>
