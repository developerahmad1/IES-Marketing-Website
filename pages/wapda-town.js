...
import img1 from "../public/wapdaTownImg.jpg";
import img2 from "../public/wapdatown3.jpg";
            ...
            <div className='mt[87px]'>
                <header className="mb-14">
                    <div
                        ...
                        style={{
                            backgroundImage: `url('/wapdaTownImg.jpg')`  // Using the imported image
                        }}
                    >
                                    ...
                                    <div className="max-w-4xl mx-auto text-center">
                                        ...
                                        <div onClick={openLeadpoup}>
                                            <a
                                                ...
                                                href="https://wa.me/923326030828?text=Hi.%20Sir%20I%20am%20interested%20in%20Wapda%20Town.%20Can%20get%20More%20Information%20About%20it%20?" target='_main'
                                            >
                                                Book Now
                                            </a>
                                        </div>
                ...
                <div className="bg-white text-black text-justify min-h-screen px-4 md:px-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <Image src={img2} alt="Wapda town main gate" className='mb-12' />
                        ...
                        <section className="mb-12">
                            <h2 className="text-3xl font-bold mb-4 text-start">Main Features of Wapda Town Multan</h2>
                                <p className="text-lg leading-relaxed">Some prominent features of Wapda Town Multan are:</p>
                        ...
                        <section className='mb-12'>
                            ...
                            <p className="text-lg leading-relaxed">
                                Contact IES Marketing or visit the office for more details and better guidance. We will find the best plot for you thatfulfills the requirements of a dream house. We deal in many other popular housing schemes, including <Link href="/smart-housing" className='text-blue-500 hover:underline'>Smart Housing Multan</Link> , <Link href="/adams-housing" className='text-blue-500 hover:underline'>Adams Housing Multan</Link>, Multan Central, <Link href="/royal-swiss" className='text-blue-500 hover:underline'>Royal Swiss</Link>, <Link href="/royal-orchard-multan" className='text-blue-500 hover:underline'>Royal Orchard</Link>, <Link href="/dha-multan" className='text-blue-500 hover:underline'>DHA Multan</Link>, Model Town, and <Link href="/citi-housing-multan" className='text-blue-500 hover:underline'>Citi Housing Multan</Link>. You can reach out to our team for bookings and suggestions related to investment.
                            </p>
                        </section>
