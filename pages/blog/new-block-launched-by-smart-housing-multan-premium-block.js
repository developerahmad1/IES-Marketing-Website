...
import img from "../../public/Blogs/Blog5.jpg"
import img1 from "../../public/Blogs/Blog5_1.png"
import img2 from "../../public/Blogs/Blog5_2.jpg"
...
const NewBlockPremiumBlock = () => {
    return (
        <div className='bg-white'>
            <Head>
                <title>Naew Block Launched by Smart Housing Multan: Premium Block</title>
            </Head>
                ...
                <main>
                    <div className="mb-4 md:mb-0 w-full mx-auto relative">
                        <div className="px-4 py-2 sm:py-2 lg:px-0">
                            ...
                            <h1 className="text-3xl sm:text-4xl font-semibold text-gray-800 leading-tight mt-8">New Block Launched by Smart Housing Multan: Premium Block</h1>
                    ...
                    <div className="flex flex-col lg:flex-row lg:space-x-12 text-justify">
                        ...
                        <Image src={img2} alt="Location of Smart Housing premium Block"   className="pb-6 mx-auto w-full sm:w-auto"/>
                            <h3 className="text-xl sm:text-3xl font-semibold text-gray-800 leading-tight">
                            ...
                            <Image src={img1} alt="" className="mx-auto pb-6" />
