...
const AComprehensiveGuideToInvestInRealEstate_6 = () => {
    return (
        <div className='bg-white'>
            <Head>
                <title>A Comprehensive Guide to Invest in Real Estate</title>
            </Head>
                ...
                <main>
                    ...
                    <div className="flex flex-col lg:flex-row lg:space-x-12 text-justify">
                        <div className="px-4 lg:px-0 mt-12 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
                            ...
                            <p className="pb-6">
                                You can contact <Link href="/" className='text-blue-500 hover:underline'>IES Marketing</Link> for further guidance and to find the right property for you. You can also visit our office in Model Town to discuss your queries.
                            </p>
                            <p className="pb-6">
