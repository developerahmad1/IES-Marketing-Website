...
const Adamshousing = () => {
  ...
  const altNames = [
    "Adams main Enterance",
    "Adams main Enterance",
    "Adams Housing main Boulevard",
    "Adams Housing Multan City",
    "Adams Housing Multan",
    "Adams Housing Entrance Gate",
    "Adams Housng High quality infrastructure",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Adams Housing, Adams Housing Multan, Adams Housing Society, Best Societies in Multan, Pakistan Real Estate, Real Estate Investment"
        />
        <meta
          name="description"
          content="Adams Housing Multan, developed by Adams Group, stands as a beacon of modern living. It provides contemporary amenities and convenience"
        />
                  ...
                  <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div onClick={openLeadpoup}>
                      <a
                        ...
                        href="https://wa.me/923338400106?text=Hi.%20Sir%20I%20am%20interested%20in%20Adams%20Housing.%20Can%20get%20More%20Information%20About%20it%20?"
                        target="_main"
                      >
                        Book Now
                      </a>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Adams Housing Multan Developer History and Owners
              </h2>
              <p className="text-lg leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Successfully delivered projects of Adams Group.
              </h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Adams Housing Multan NOC Status
              </h2>
              <p className="text-lg leading-relaxed">
                Some
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Adams Housing Multan Development Status
              </h2>
              <p className="text-lg leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl text-start font-bold mb-4">
                Main features of Adams Housing Multan
              </h2>
              <p className="text-lg leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Adams Housing Multan Location
              </h2>
              <p className="text-lg leading-relaxed">
                Adams Housing Multan Society is located near the Judicial
                Complex or New Katchery in Mouza Jahangirabad. It has two
                entrance gates on two main routes: Mattital Road and Northern
                Bypass Road opposite PIA Employees Housing. Additionally, this
                society became popular for its prime location, which allows
                easier access and ensures that residents are never far from
                essential services.
              </p>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Adams Housing Multan Accessibilities
              </h2>
              <p className="text-lg leading-relaxed">
                Adams Housing Multan offers a lucrative investment opportunity
                due to its robust infrastructure, modern amenities, and
                strategic location. Some nearest accessibilities to Adams
                Housing are:
              </p>
              <ul className="list-disc ml-5 text-lg leading-relaxed">
                ...
                <li>
                  Almost 2 minutes from Bakhtawar Amin Medical and Dental
                  Hospital
                </li>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-start">
                Popular Places near Adams Housing Multan
              </h2>
              <p className="text-lg leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <div className="flex justify-start items-start mt-10 gap-5 flex-wrap">
                <Image
                  src={payementPlan1}
                  alt="Adams Housing Payment Plan"
                  className="mx-auto sm:max-w-[400px] border rounded-xl transition-all duration-[0.5s] hover:border-black hover:shadow-xl w-full"
                />
                <Image
                  src={payementPlan2}
                  alt="Adams Housing Payment Plan"
                  className="mx-auto sm:max-w-[400px] border rounded-xl transition-all duration-[0.5s] hover:border-black hover:shadow-2xl w-full"
                />
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc ml-5 text-lg leading-relaxed">
                ...
                <li>
                  Confirmation amount needs to be paid within 30 days of booking
                </li>
              </ul>
            </section>
            ...
            {/* conclusion */}
            <section className="mb-12">
              <h3 className="text-3xl font-bold mb-4 text-start">Conclusion</h3>
              <p className="text-lg leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <p className="text-[15px] sm:text-lg leading-relaxed">
                A
                {`dams Housing Multan is a legally approved society from Multan Developmental Authority. Its land area of 1000 Kanal is approved for development and sale. It received &apos;No Objection Certificate&apos; from developmental authorities of Multan to gain trust of investors and known as an authentic or legal society.`}
              </p>
              <h3 className="text-xl font-semibold mt-5 text-start">
