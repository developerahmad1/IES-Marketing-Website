...
const ApplicationForm = ({ jobCategory }) => {
    ...
    useEffect(() => {
        emailjs.init('-Fdp5T8n_Ca_dlvEe'); // Replace with your actual User ID
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await emailjs.send('service_onwlkzy', 'template_evxa0e4', {
                firstName,
                lastName,
                email,
                phone,
                ...
                <div className="flex flex-col items-center justify-center bg-gray-900 text-white pb-[50px]">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 my-5 px-2 lg:px-[250px] text-center">
                            Explore the opportunities aligning with your qualifications and career goals. Take the next step in your career with{' '}
                            <span className="text-[#ff8e2b]">IES Marketing</span> by submitting your application.
                        </p>
                    </div>
                </div>
