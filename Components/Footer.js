          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                ...
                <li><Link href="/blogs" className='hover:text-[#fa8b17]'>Blogs</Link></li>
                <li><Link href="/gallery" className='hover:text-[#fa8b17]'>Gallery</Link></li>
                <li><Link href="/career" className='hover:text-[#fa8b17]'>Career</Link></li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <li><Link href="/adams-housing" className='hover:text-[#fa8b17]'>Adams Housing</Link></li>
              <li><Link href="/citi-housing-multan" className='hover:text-[#fa8b17]'>CITI Housing</Link></li>
              <li><Link href="/dha-multan" className='hover:text-[#fa8b17]'>DHA Multan</Link></li>
              <li><Link href="/royal-orchard-multan" className='hover:text-[#fa8b17]'>Royal Orchard</Link></li>
              </ul>
            </div>
